    ...
    <div className="grid gap-5 lg:grid-cols-[0.8fr_1.2fr]">
      <div className="grid content-start gap-4">
        ...
        <div className="rounded-lg border border-lens-line bg-slate-50 p-4">
          <p className="text-xs font-semibold uppercase tracking-wide text-lens-muted">σ(x)</p>
      ...
      <div className="rounded-lg border border-lens-line bg-slate-50 p-4">
        <svg className="h-64 w-full" viewBox="0 0 360 220" role="img" aria-label="Sigmoid curve">
          ...
          <text x={mapX(x)} y={mapY(y) - 14} textAnchor="middle" className="fill-slate-700 text-[12px] font-semibold">
            {y.toFixed(2)}
          </text>
        </svg>
      </div>
